    ...
    void getUserData(BuildContext context) async {
      try {
        ...
        if (token == null || token.isEmpty) {
          // Token is not present or empty, navigate to login screen or handle it accordingly
          // For example, you can show the login screen:
        ...
        if (response == true) {
          ...
          // Token is not valid, navigate to login screen or handle it accordingly
          // ignore: use_build_context_synchronously
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(
